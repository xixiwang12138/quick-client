...
import {Box, Breadcrumbs, breakPoints, Button, CopyIcon,} from "mds";
import {hasPermission} from "../../../common/SecureComponent";
import {IAM_SCOPES,} from "../../../common/SecureComponent/permissions";
import withSuspense from "../Common/Components/withSuspense";
import {setSnackBarMessage} from "../../../systemSlice";
import {AppState, useAppDispatch} from "../../../store";
import {setSelectedObjectView, setVersionsModeEnabled} from "./objectBrowserSlice";
...
const BrowserBreadcrumbs = ({
    ...
    const goBackFunction = () => {
        if (versionsMode) {
            ...
            const internalPath = prevPath.length > 0
                ? `${encodeURLString(`${prevPath.join("/")}/`)}`
                : ""
            navigate(
                `/browser/${bucketName}/${internalPath}`,
            );
            dispatch(setSelectedObjectView(internalPath))
        }
    };
